...
/** User stub definition for function: _Bool could_intel_with_player(const struct player *, const struct player *) */
EXTERN_C_LINKAGE _Bool could_intel_with_player (const struct player * pplayer, const struct player * aplayer) ;
EXTERN_C_LINKAGE _Bool CppTest_Stub_could_intel_with_player (const struct player * pplayer, const struct player * aplayer) 
{
